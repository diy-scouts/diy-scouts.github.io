...
- To generate badge html pages, add/make changes to `badges-src` files, then run `node scripts/build.js`
...
- Limit scripting - none should be required for primary site functionality
- All uses of script should come with a non-scripted fallback
